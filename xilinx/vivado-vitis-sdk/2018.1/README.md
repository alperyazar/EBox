...
```shell
sudo docker build --file Dockerfile-setup --tag vivado:2018.1-setup .
```
...
```shell
sudo docker run --rm -it vivado:2018.1-setup
```
...
```shell
sudo docker run --rm -it --user ebox vivado:2018.1-$TAG
```
